...
import com.gd.intership.hdziedziura.androidshopingapp.databinding.FragmentShopWomenBinding
...
class ShopWomenFragment : BaseFragment() {

    private val viewModel: ShopWomenViewModel by viewModels()
    private val parentViewModel: ShopViewModel by parentFragmentViewModels()
    private lateinit var binding: FragmentShopWomenBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_shop_women, container, false
        )
